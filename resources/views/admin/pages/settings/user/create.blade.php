...
@section('content')
    <div class="container" style="transform: none;">
        <div class="row" style="transform: none;">
            <form action="{{ route('admin.settings.store_user') }}" method="POST" enctype="multipart/form-data" id="userForm" onsubmit="validateUser(event)">
                @csrf
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" placeholder="Enter Confirm Password"
                                                name="c_password" id="c_password" oninput="checkPasswords()" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
