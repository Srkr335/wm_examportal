                    ...
                    <div class="col-md-12">
                        <div class="add-course-header pb-0">
                            ...
                            <div class="add-course-btns">
                                <ul class="nav">
                                    {{-- <li>
                                        <a href="{{ route('admin.student.index') }}" class="btn btn-black">Back to Students</a>
                                    </li> --}}
                                    <li>
                                        ...
                                        <div class="col-md-12 col-12 d-flex justify-content-center">
                                            ...
                                            <div class="course-name d-flex align-items-center">
                                                ...
                                                <div class=" upload-profile-icon"> --}}
                                                    ...
                                                    <label class="profile-image-circle">
                                                        @if (!empty($student->image))
                                                            <img src="{{ asset('/images/student/' . $student->image) }}"
                                                                alt="" id="ImagePreview" class="h-100 Profile-img">
                                                        @else
                                                            <img src="{{ asset('img/new-icons/upload.png') }}"
                                                                alt="" id="ImagePreview" class="h-100 Profile-img">
                                                        @endif
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Name"
                                                name="name" required value="{{ $student->user->name }}">
                                        </div>
                                    </div>
                                    {{-- <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter your Phone"
                                                name="phone" value="{{ $student->user->mobile_no }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter your Email"
                                                name="email" required value="{{ $student->user->email }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select country-select select2-hidden-accessible"
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        @if ($student->country_id == $country->id) selected @endif>
                                                        {{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    {{-- <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select" name="payment_status">
                                                <option value="0"
                                                    {{ $student->payment_status == 0 ? 'selected' : '' }}>Un Paid</option>
                                                <option value="1"
                                                    {{ $student->payment_status == 1 ? 'selected' : '' }}>Paid</option>
                                    ...
                                    {{-- <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Amount"
                                                name="payment_amount" value="{{ $student->payment_amount }}">
                                        </div>
                                    </div> --}}
